...
namespace Easynvest.Infohub.Parse.Api.Controllers
{
    ...
    [Route("Issuer")]
    [ApiController]
    public class IssuerParseController : Controller
    {
        private readonly IMediator _mediator;
        public IssuerParseController(IMediator mediator)
        {
            _mediator = mediator;
        }
        ...
        {
            if (issuerNameCetip is null)
            {
                return NotFound();
            }

            var command = new DeleteIssuerParseCommand { IssuerNameCetip = issuerNameCetip };
